...
add --set target.x86_64-pc-qnx.cc=qcc
add --set target.x86_64-pc-qnx.cxx=q++
add --set target.x86_64-pc-qnx.ar=ntox86_64-ar
add --set target.x86_64-pc-qnx.profiler=false # Build failures were noted if this is enabled.
add --set target.aarch64-unknown-qnx.cc=qcc
add --set target.aarch64-unknown-qnx.cxx=q++
add --set target.aarch64-unknown-qnx.ar=ntox86_64-ar
