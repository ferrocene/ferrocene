...
if [[ "${FERROCENE_BUILD_HOST:-}" = "x86_64-pc-windows-msvc" ]]; then
    ...
    add --set target.aarch64a53-unknown-none.cc=clang
    add --set target.aarch64a53-unknown-none.cxx=clang
    add --set target.aarch64a53-unknown-none.ar=llvm-ar
    ...
    add --set target.thumbm4-none-eabihf.cc=clang
    add --set target.thumbm4-none-eabihf.cxx=clang
    add --set target.thumbm4-none-eabihf.ar=llvm-ar
...
add --set 'target."aarch64a53-unknown-none".cc=aarch64-linux-gnu-gcc'
add --set 'target."aarch64-unknown-ferrocene.facade".cc=aarch64-linux-gnu-gcc'
add --set 'target."aarch64a53-unknown-ferrocene.facade".cc=aarch64-linux-gnu-gcc'
...
add --set 'target."thumbm4-ferrocene.facade-eabihf".cc=arm-none-eabi-gcc'
...
add --set 'target."thumbm4-none-eabihf".cc=arm-none-eabi-gcc'
add --set 'target."aarch64-ferrocene-none".cc=aarch64-linux-gnu-gcc'
add --set 'target."aarch64a53-ferrocene-none".cc=aarch64-linux-gnu-gcc'
...
add --set 'target."thumbm4-ferrocene-none-eabihf".cc=arm-none-eabi-gcc'
...
add --set 'target."aarch64a53-unknown-ferrocene.facade".profiler=true'
...
add --set 'target."thumbm4-ferrocene.facade-eabihf".profiler=true'
