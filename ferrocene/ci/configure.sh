...
add --set 'target."powerpc64le-unknown-linux-gnu".cc=powerpc64le-linux-gnu-gcc-10'
add --set 'target."powerpc64le-unknown-linux-gnu".cxx=powerpc64le-linux-gnu-g++-10'
add --set 'target."s390x-unknown-linux-gnu".cc=s390x-linux-gnu-gcc-10'
add --set 'target."s390x-unknown-linux-gnu".cxx=s390x-linux-gnu-g++-10'
