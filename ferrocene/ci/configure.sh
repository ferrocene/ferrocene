...
if [[ -n "${FERROCENE_UNPRIVILEGED_CI+x}" ]]; then
    ...
    add --set ferrocene.compiler-technical-report-url="s3://ferrocene-ci-mirrors/manual/tuv-technical-reports/2026-07-27-ferrocene-26.05.0-compiler-technical-report.pdf"

    # Include the core library technical report from the assessor in the documentation.
    #
    # If this is not provided, the report will not be included in the generated
    # documentation. This should only be set in stable, qualified releases.
    add --set ferrocene.core-technical-report-url="s3://ferrocene-ci-mirrors/manual/tuv-technical-reports/2026-07-27-ferrocene-26.05.0-core-technical-report.pdf"
fi
