...
# Do not build a parallel-compiler
# This is an unstable feature we do not use while also preventing us from testing the compiler
# crates on their own due to invalid cargo feature usage within the compiler.
add --set rust.parallel-compiler=false
