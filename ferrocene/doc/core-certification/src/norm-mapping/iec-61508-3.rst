...
No online tools are used for the core library certification, only offline tools. In :doc:`core-certification:safety-plan/tools` all used tools are specified and justified.
