...
* A new target is now supported and qualified for safety critical use. The new target is:
  ...
  * :target-with-tuple:`aarch64-rhivos2-linux-gnu` (from a :target-with-tuple:`aarch64-unknown-linux-gnu` host)
  * :target-with-tuple:`aarch64-unknown-linux-gnu` (to a :target-with-tuple:`aarch64-unknown-linux-gnu` target)
