...
.. cli:program:: rustc
   ...
   .. cli:option:: -C target-cpu=<cpu>
      ...
      This code generation option is **unsafe**: it is undefined behavior to
      execute a binary on a CPU older than the chosen target CPU.
   ...
   .. cli:option:: -C target-feature=<features>
      ...
      This code generation option is **unsafe**: it is undefined behavior to
      execute a binary compiled with a target feature not supported by the
      hardware the binary is executed on.
