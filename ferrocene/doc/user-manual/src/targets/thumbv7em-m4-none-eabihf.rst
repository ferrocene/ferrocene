...
The ``thumbv7em-m4-none-eabihf`` Ferrocene target provides support for
...
* ``rust-std-thumbv7em-m4-none-eabihf``
...
* ``rust-std-thumbv7em-m4-ferrocene.facade-eabihf``
...
``thumbv7em-ferrocene.m4-none-eabihf``. To use the certified core library, the
following additional flags must be provided to ``rustc``:

* ``--target=thumbv7em-ferrocene.m4-none-eabihf``
