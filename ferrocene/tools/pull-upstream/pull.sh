...
echo ".gitmodules before git submodule update --init"
cat .gitmodules
echo ".git/config before git submodule update --init"
cat .git/config
...
echo ".gitmodules after git submodule update --init"
cat .gitmodules
echo ".git/config after git submodule update --init"
cat .git/config
