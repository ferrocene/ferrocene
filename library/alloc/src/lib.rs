...
#![cfg_attr(not(feature = "ferrocene_certified"), feature(copied_into_inner))]
...
#![cfg_attr(not(feature = "ferrocene_certified"), feature(fmt_arguments_from_str))]
...
#![cfg_attr(not(feature = "ferrocene_certified"), feature(rev_into_inner))]
...
#![cfg_attr(not(feature = "ferrocene_certified"), feature(transmutability))]
