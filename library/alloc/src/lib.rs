...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(array_windows))]
...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(char_max_len))]
...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(maybe_uninit_slice))]
