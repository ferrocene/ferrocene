...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_clone))]
...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_destruct))]
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_eval_select))]
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_heap))]
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_option_ops))]
#![cfg_attr(not(feature = "ferrocene_subset"), feature(const_try))]
...
#![cfg_attr(not(feature = "ferrocene_subset"), feature(freeze))]
