...
///
/// If building the subset targets, as is done when executing `./x test library/core --tests --coverage=library`, it is necessary to mark those function calls with `#[cfg(not(feature = "ferrocene_subset"))]`.
///
