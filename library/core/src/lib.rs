...
#![cfg_attr(true, feature(array_ptr_get))]
#![cfg_attr(true, feature(asm_experimental_arch))]
#![cfg_attr(true, feature(bigint_helper_methods))]
#![cfg_attr(true, feature(bstr))]
#![cfg_attr(true, feature(bstr_internals))]
#![cfg_attr(true, feature(cfg_select))]
#![cfg_attr(true, feature(cfg_target_has_reliable_f16_f128))]
#![cfg_attr(true, feature(const_carrying_mul_add))]
#![cfg_attr(true, feature(const_cmp))]
#![feature(const_destruct)]
#![feature(const_eval_select)]
#![cfg_attr(true, feature(const_select_unpredictable))]
#![feature(core_intrinsics)]
#![feature(coverage_attribute)]
#![cfg_attr(true, feature(disjoint_bitor))]
#![feature(internal_impls_macro)]
#![cfg_attr(true, feature(ip))]
#![cfg_attr(true, feature(is_ascii_octdigit))]
#![cfg_attr(true, feature(lazy_get))]
#![cfg_attr(true, feature(link_cfg))]
#![cfg_attr(true, feature(offset_of_enum))]
#![feature(panic_internals)]
#![cfg_attr(true, feature(ptr_alignment_type))]
#![cfg_attr(true, feature(ptr_metadata))]
#![cfg_attr(true, feature(set_ptr_value))]
#![cfg_attr(true, feature(slice_ptr_get))]
#![cfg_attr(true, feature(str_internals))]
#![cfg_attr(true, feature(str_split_inclusive_remainder))]
#![cfg_attr(true, feature(str_split_remainder))]
#![cfg_attr(true, feature(pattern_type_macro))]
#![feature(ub_checks)]
#![cfg_attr(true, feature(unchecked_neg))]
#![cfg_attr(true, feature(unchecked_shifts))]
#![cfg_attr(true, feature(unsafe_pinned))]
#![cfg_attr(true, feature(utf16_extra))]
#![cfg_attr(true, feature(variant_count))]
// not-alphabetical-end
//
// Language features:
// not-alphabetical-start
#![cfg_attr(true, feature(abi_unadjusted))]
#![feature(adt_const_params)]
#![feature(allow_internal_unsafe)]
#![feature(allow_internal_unstable)]
#![feature(auto_traits)]
#![cfg_attr(true, feature(cfg_sanitize))]
...
#![feature(doc_cfg)]
#![cfg_attr(true, feature(doc_notable_trait))]
#![feature(extern_types)]
#![feature(f128)]
#![feature(f16)]
#![feature(freeze_impls)]
#![feature(fundamental)]
#![cfg_attr(true, feature(funnel_shifts))]
#![cfg_attr(true, feature(if_let_guard))]
#![feature(intra_doc_pointers)]
#![feature(intrinsics)]
#![feature(lang_items)]
#![cfg_attr(true, feature(link_llvm_intrinsics))]
#![feature(macro_metavar_expr)]
#![cfg_attr(true, feature(macro_metavar_expr_concat))]
#![feature(marker_trait_attr)]
#![feature(min_specialization)]
#![feature(multiple_supertrait_upcastable)]
#![cfg_attr(true, feature(must_not_suspend))]
...
#![feature(reborrow)]
#![cfg_attr(true, feature(repr_simd))]
#![feature(rustc_allow_const_fn_unstable)]
#![feature(rustc_attrs)]
#![feature(rustdoc_internals)]
#![cfg_attr(true, feature(simd_ffi))]
#![feature(staged_api)]
...
#![cfg_attr(true, feature(unsized_fn_params))]
#![cfg_attr(true, feature(with_negative_coherence))]
// not-alphabetical-end
//
// Target features:
// not-alphabetical-start
#![cfg_attr(true, feature(aarch64_unstable_target_feature))]
#![cfg_attr(true, feature(arm_target_feature))]
#![cfg_attr(true, feature(hexagon_target_feature))]
#![cfg_attr(true, feature(loongarch_target_feature))]
#![cfg_attr(true, feature(mips_target_feature))]
#![cfg_attr(true, feature(powerpc_target_feature))]
#![cfg_attr(true, feature(nvptx_target_feature))]
#![cfg_attr(true, feature(riscv_target_feature))]
#![cfg_attr(true, feature(rtm_target_feature))]
#![cfg_attr(true, feature(s390x_target_feature))]
#![cfg_attr(true, feature(wasm_target_feature))]
#![cfg_attr(true, feature(x86_amx_intrinsics))]
// not-alphabetical-end
//
