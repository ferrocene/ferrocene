...
<<<<<<< HEAD:library/core/src/num/dec2flt/mod.rs
...
||||||| d933cf483ed:library/core/src/num/dec2flt/mod.rs
use self::common::BiasedFp;
use self::float::RawFloat;
use self::lemire::compute_float;
use self::parse::{parse_inf_nan, parse_number};
...
>>>>>>> pull-upstream-temp--do-not-use-for-real-code:library/core/src/num/imp/dec2flt/mod.rs
