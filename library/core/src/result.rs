...
#[doc(search_unbox)]
#[cfg_attr(feature = "uncertified", derive(Copy, PartialEq, PartialOrd, Eq, Ord, Debug, Hash))]
...
impl<T, E> Result<Result<T, E>, E> {
    ...
    #[cfg(feature = "uncertified")] /* blocked on const impl Drop for Result<Result<T, E>> */
