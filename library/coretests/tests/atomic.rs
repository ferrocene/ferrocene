...
fn atomic_compare_exchange() {
    ...
    let _ = ATOMIC.compare_exchange(0, 0, Relaxed, Relaxed);
    let _ = ATOMIC.compare_exchange(1, 1, Relaxed, Relaxed);
    let _ = ATOMIC.compare_exchange(0, 0, Relaxed, Acquire);
    let _ = ATOMIC.compare_exchange(1, 1, Relaxed, Acquire);
    let _ = ATOMIC.compare_exchange(0, 0, Relaxed, SeqCst);
    let _ = ATOMIC.compare_exchange(1, 1, Relaxed, SeqCst);
    let _ = ATOMIC.compare_exchange(0, 0, Acquire, Relaxed);
    let _ = ATOMIC.compare_exchange(1, 1, Acquire, Relaxed);
    let _ = ATOMIC.compare_exchange(0, 0, Acquire, Acquire);
    let _ = ATOMIC.compare_exchange(1, 1, Acquire, Acquire);
    let _ = ATOMIC.compare_exchange(0, 0, Acquire, SeqCst);
    let _ = ATOMIC.compare_exchange(1, 1, Acquire, SeqCst);
    let _ = ATOMIC.compare_exchange(0, 0, Release, Relaxed);
    let _ = ATOMIC.compare_exchange(1, 1, Release, Relaxed);
    let _ = ATOMIC.compare_exchange(0, 0, Release, Acquire);
    let _ = ATOMIC.compare_exchange(1, 1, Release, Acquire);
    let _ = ATOMIC.compare_exchange(0, 0, Release, SeqCst);
    let _ = ATOMIC.compare_exchange(1, 1, Release, SeqCst);
    let _ = ATOMIC.compare_exchange(0, 0, AcqRel, Relaxed);
    let _ = ATOMIC.compare_exchange(1, 1, AcqRel, Relaxed);
    let _ = ATOMIC.compare_exchange(0, 0, AcqRel, Acquire);
    let _ = ATOMIC.compare_exchange(1, 1, AcqRel, Acquire);
    let _ = ATOMIC.compare_exchange(0, 0, AcqRel, SeqCst);
    let _ = ATOMIC.compare_exchange(1, 1, AcqRel, SeqCst);
    let _ = ATOMIC.compare_exchange(0, 0, SeqCst, Relaxed);
    let _ = ATOMIC.compare_exchange(1, 1, SeqCst, Relaxed);
    let _ = ATOMIC.compare_exchange(0, 0, SeqCst, Acquire);
    let _ = ATOMIC.compare_exchange(1, 1, SeqCst, Acquire);
    let _ = ATOMIC.compare_exchange(0, 0, SeqCst, SeqCst);
    let _ = ATOMIC.compare_exchange(1, 1, SeqCst, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Relaxed, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Relaxed, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Relaxed, Acquire);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Relaxed, Acquire);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Relaxed, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Relaxed, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Acquire, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Acquire, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Acquire, Acquire);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Acquire, Acquire);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Acquire, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Acquire, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Release, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Release, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Release, Acquire);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Release, Acquire);
    let _ = ATOMIC.compare_exchange_weak(0, 0, Release, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(1, 1, Release, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(0, 0, AcqRel, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(1, 1, AcqRel, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(0, 0, AcqRel, Acquire);
    let _ = ATOMIC.compare_exchange_weak(1, 1, AcqRel, Acquire);
    let _ = ATOMIC.compare_exchange_weak(0, 0, AcqRel, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(1, 1, AcqRel, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(0, 0, SeqCst, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(1, 1, SeqCst, Relaxed);
    let _ = ATOMIC.compare_exchange_weak(0, 0, SeqCst, Acquire);
    let _ = ATOMIC.compare_exchange_weak(1, 1, SeqCst, Acquire);
    let _ = ATOMIC.compare_exchange_weak(0, 0, SeqCst, SeqCst);
    let _ = ATOMIC.compare_exchange_weak(1, 1, SeqCst, SeqCst);
}
