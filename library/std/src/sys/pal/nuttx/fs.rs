...
use libc::{
    c_int, dirent as dirent64, fstat as fstat64, ftruncate as ftruncate64, lseek as lseek64,
    mode_t, off_t as off64_t, open3 as open64, readdir_r as readdir64_r, stat as stat64,
    lstat as lstat64
};
