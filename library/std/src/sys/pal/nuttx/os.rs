...
#[cfg(target_os = "nuttx")]
use libc::{__errno as errno_location, strerror_r};
...
#[cfg(not(any(target_vendor = "apple", target_os = "nuttx")))]
pub unsafe fn environ() -> *mut *const *const c_char {
    extern "C" {
...
pub fn env() -> Env {
    unsafe {
        ...
        #[cfg(target_os = "nuttx")]
        let mut environ = libc::get_environ_ptr();
...
// base: src/sys/pal/unsupported/os.rs
// pub fn errno() -> i32 {
//     0
// }
