...
// base: sys/pal/unix/process/process_unix.rs
...
impl Command {
    ...
    unsafe fn do_exec(
        ...
        libc::execvpe(
            ...
            maybe_envp.map(|envp| envp.as_ptr()).unwrap_or_else(|| core::ptr::null_mut()),
        );
...
// base: src/sys/pal/unsupported/process.rs
// ////////////////////////////////////////////////////////////////////////////////
// // Command
// ////////////////////////////////////////////////////////////////////////////////
