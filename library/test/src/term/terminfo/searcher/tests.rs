...
fn test_get_dbpath_for_term() {
    ...
    use std::env;
    fn x(t: &str) -> PathBuf {
        // Ferrocene annotation: modified to have a static lifetime.
        // FIXME: revert this once we certify core::fmt.
        get_dbpath_for_term(t).expect("no terminfo entry found for {t:?}")
    }
