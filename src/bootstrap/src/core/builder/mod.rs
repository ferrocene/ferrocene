...
<<<<<<< HEAD:src/bootstrap/src/core/builder.rs
    check, clean, clippy, compile, dist, doc, gcc, llvm, run, setup, test, vendor,
=======
    check, clean, clippy, compile, dist, doc, gcc, install, llvm, run, setup, test, tool, vendor,
>>>>>>> pull-upstream-temp--do-not-use-for-real-code:src/bootstrap/src/core/builder/mod.rs
};
...
<<<<<<< HEAD:src/bootstrap/src/core/builder.rs
    ...
    pub fn cargo(
        ...
        let allow_features = match mode {
            ...
            Mode::Std | Mode::Rustc | Mode::Codegen | Mode::ToolRustc | Mode::ToolCustom { .. } => {
                String::new()
            }
        };
        ...
        let debuginfo_level = match mode {
            ...
            Mode::ToolBootstrap | Mode::ToolStd | Mode::ToolRustc | Mode::ToolCustom { .. } => {
