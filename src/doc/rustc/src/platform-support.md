...
`x86_64-unknown-ferrocene.certified` | * |  | Freestanding/bare-metal x86_64, softfloat (certified)
`aarch64-unknown-ferrocene.certified` | * |  | Bare ARM64, hardfloat (certified)
`thumbv7em-ferrocene.certified-eabi` | * |  | Bare Armv7E-M (certified)
`thumbv7em-ferrocene.certified-eabihf` | * |  | Bare Armv7E-M, hardfloat (certified)
