...
complete -c x -n "__fish_x_using_subcommand test" -l test-variant -d 'Choose the test variant to use for this execution' -r -f -a "{2021\t'',2021-cortex-a53\t'',2021-specific-cortex-a53\t'',2021-neoverse-v1\t'',2021-cortex-m4\t'',2021-cortex-m33\t'',2021-cortex-r5f\t'',2021-specific-cortex-m4\t''}"
...
complete -c x -n "__fish_x_using_subcommand t" -l test-variant -d 'Choose the test variant to use for this execution' -r -f -a "{2021\t'',2021-cortex-a53\t'',2021-specific-cortex-a53\t'',2021-neoverse-v1\t'',2021-cortex-m4\t'',2021-cortex-m33\t'',2021-cortex-r5f\t'',2021-specific-cortex-m4\t''}"
