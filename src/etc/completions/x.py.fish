...
complete -c x.py -n "__fish_x.py_using_subcommand d" -l serve -d 'start a live-relodaing web server'
complete -c x.py -n "__fish_x.py_using_subcommand d" -l debug-sphinx -d 'allow easier debugging of Sphinx extensions'
...
complete -c x.py -n "__fish_x.py_using_subcommand test" -l test-variant -d 'Choose the test variant to use for this execution' -r -f -a "{2021\t'',2021-cortex-a53\t'',2021-specific-cortex-a53\t'',2021-neoverse-v1\t'',2021-cortex-m4\t'',2021-cortex-m33\t'',2021-cortex-r5f\t'',2021-specific-cortex-m4\t''}"
...
complete -c x.py -n "__fish_x.py_using_subcommand t" -l test-variant -d 'Choose the test variant to use for this execution' -r -f -a "{2021\t'',2021-cortex-a53\t'',2021-specific-cortex-a53\t'',2021-neoverse-v1\t'',2021-cortex-m4\t'',2021-cortex-m33\t'',2021-cortex-r5f\t'',2021-specific-cortex-m4\t''}"
...
complete -c x.py -n "__fish_x.py_using_subcommand t" -l ferrocene-test-one-crate-per-cargo-call -d 'Test only one crate per Cargo invocation. This is needed by the Ferrocene qualification documents to ensure there is enough granularity for the test outcomes report'
...
complete -c x.py -n "__fish_x.py_using_subcommand r" -l bless -d 'update all files of failing tests'
...
complete -c x.py -n "__fish_x.py_using_subcommand sign" -l keep-stage-std -d 'stage(s) of the standard library to keep without recompiling (pass multiple times to keep e.g., both stages 0 and 1)' -r -f
complete -c x.py -n "__fish_x.py_using_subcommand sign" -l src -d 'path to the root of the rust checkout' -r -f -a "(__fish_complete_directories)"
complete -c x.py -n "__fish_x.py_using_subcommand sign" -s j -l jobs -d 'number of jobs to run in parallel' -r -f
