...
//  QNX SDP 7.1 with io-sock or relibc or SGX or Simulator or uClibc or V5 or \
//  WASIp1 or WASIp2 or WASIp3 only.'
#[doc(cfg(any(
    target_env = "gnu",
    target_env = "macabi",
    target_env = "mlibc",
...
//  and QNX SDP 7.x and QNX SDP 8.0+ and QuRT and Redox OS and RTEMS OS and \
//  Solaris and SOLID ASP3 and TEEOS and Trusty and tvOS and UEFI and VEXos and \
//  visionOS and VxWorks and WASI and watchOS and Windows and Xous and zero knowledge \
