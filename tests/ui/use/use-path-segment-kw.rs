...
macro_rules! macro_dollar_crate {
    () => {
        ...
        type A2 = ::$crate; //~ ERROR global paths cannot start with `$crate`
        ...
        type A4 = crate::$crate; //~ ERROR `$crate` in paths can only be used in start position
        ...
        type A5 = super::$crate; //~ ERROR `$crate` in paths can only be used in start position
        ...
        type A6 = self::$crate; //~ ERROR `$crate` in paths can only be used in start position
        ...
        type A7 = $crate::$crate; //~ ERROR `$crate` in paths can only be used in start position
        use $crate::$crate; //~ ERROR `$crate` in paths can only be used in start position
        ...
        type A8 = $crate::crate; //~ ERROR `crate` in paths can only be used in start position
        use $crate::crate; //~ ERROR `crate` in paths can only be used in start position
...
mod foo {
    pub mod bar {
        ...
        type B2 = ::crate; //~ ERROR global paths cannot start with `crate`
        use ::crate; //~ ERROR `crate` in paths can only be used in start position
        ...
        type B4 = crate::crate; //~ ERROR `crate` in paths can only be used in start position
        use crate::crate; //~ ERROR `crate` in paths can only be used in start position
        ...
        type B5 = super::crate; //~ ERROR `crate` in paths can only be used in start position
        use super::crate; //~ ERROR `crate` in paths can only be used in start position
        ...
        type B6 = self::crate; //~ ERROR `crate` in paths can only be used in start position
        use self::crate; //~ ERROR `crate` in paths can only be used in start position
...
fn main() {
    ...
    foo::bar::baz::inner();
    foo::bar::_nested_self2::outer(); //[e2018]~ ERROR cannot find `_nested_self2` in `bar`
